...
void main()
{
  ...
  b0[2]=readint("Enter 1-24 nbr#3:");
  b0[3]=readint("Enter 1-24 nbr#4:");
  b0[4]=readint("Enter 1-24 nbr#5:");
  b0[5]=readint("Enter 1-24 nbr#6:");
  b0[6]=readint("Enter 1-24 nbr#7:");
  b0[7]=readint("Enter 1-24 nbr#8:");
  b0[8]=readint("Enter 1-24 nbr#9:");
